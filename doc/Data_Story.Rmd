...
use_python('/anaconda3/bin/python') ### instruction
```
...
py.plot(fig, filename = "../output/artists_scatter_plot.html", auto_open=False)
```
...
```{r, echo=FALSE}
htmltools::includeHTML("../output/artists_scatter_plot.html")
```
...
knitr::include_graphics(c("../figs/Folk.png","../figs/Metal.png"))
```
